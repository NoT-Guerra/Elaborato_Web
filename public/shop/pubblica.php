        ...
        if (strlen($titolo) > 255) {
            ...
            if (empty($titolo) || empty($descrizione) || $prezzo < 0 || empty($categoria_id) || empty($condizione_id)) {
                ...
                if (isset($_FILES['immagine']) && $_FILES['immagine']['error'] === UPLOAD_ERR_OK) {
                    ...
                    // se pdf usa immagine di default
                    ...
                    try {
                        ...
                        if ($stmt) {
                            ...
                            if ($stmt->execute()) {
                                ...
                                // crea un csrf token dopo successo
                                $_SESSION['csrf_token'] = bin2hex(random_bytes(32));
...
<body class="bg-body-tertiary">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                ...
                <form id="form-annuncio" action="pubblica.php" method="POST" enctype="multipart/form-data"
                    ...
                    <!-- ogni form ha un codice unico per verificare che la richiesta viene da questo sito (crsf)-->
                    ...
                    <div id="pdf-upload-container" class="mb-3" style="display: none;">
                        ...
                        <div class="form-text">
                            Dimensione massima: 5MB. Il file PDF sarà disponibile per il download dopo l'acquisto.
                        </div>
    ...
    <script>
        ...
        // funzione per immagine di default  pdf
        ...
        // uso funzione per immagine default se PDF 
