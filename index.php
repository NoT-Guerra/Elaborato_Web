        ...
        <div class="container-fluid p-2 p-sm-3">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex align-items-center gap-2">
                    <a href="preferiti.html" class="btn btn-link text-body p-1 p-sm-2 position-relative">
                        <i class="bi bi-suit-heart"></i>
                        <span id="cart-counter" class="badge rounded-pill bg-danger d-none">0</span>
                    </a>
                    <a href="carrello.html" class="btn btn-link text-body p-1 p-sm-2 position-relative">
                    ...
                    <a href="pubblica.html" class="btn btn-dark d-flex align-items-center px-3">
                        <i class="bi bi-plus-circle me-2"></i><span class="d-none d-md-inline">Pubblica</span>
                    </a>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="menuMobile" aria-labelledby="menuMobileLabel">
                ...
                <div class="offcanvas-body p-0">
                    <div class="p-3 d-grid gap-2">
                        <a href="login.html" class="btn btn-dark w-100 py-2 d-flex align-items-center justify-content-center gap-2">
                ...
                <div class="row g-4" id="lista-annunci">
                    <?php if (count($annunci) > 0): ?>
                        ...
                        <div class="col-xl-4 col-lg-6 annuncio" 
                             ...
                             data-facolta="<?php echo $facolta_lower; ?>"
                             data-condizione="<?php echo $condizione_lower; ?>"
                            ...
                            <div class="card h-100 border-0 shadow-sm card-annuncio">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <h6 class="fw-bold mb-0 text-truncate"><?php echo htmlspecialchars($annuncio['titolo']); ?></h6>
                                        <span class="badge bg-primary-subtle text-primary price-badge">
                                            €<?php echo number_format($annuncio['prezzo'], 2); ?>
                                        </span>
                                    </div>
                                    <p class="small text-muted mb-2"><?php echo htmlspecialchars(substr($annuncio['descrizione'], 0, 100) . (strlen($annuncio['descrizione']) > 100 ? '...' : '')); ?></p>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <span class="badge 
                                                <?php 
                                                if($condizione_lower == 'nuovo') echo 'bg-info-subtle text-info';
                                                elseif($condizione_lower == 'ottimo') echo 'bg-success-subtle text-success';
                                                elseif($condizione_lower == 'buono') echo 'bg-warning-subtle text-warning';
