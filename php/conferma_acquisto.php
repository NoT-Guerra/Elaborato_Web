        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                ...
                <div class="text-center mb-5">
                    ...
                    <p class="text-muted">Grazie per il tuo acquisto. Riceverai una email di conferma con i dettagli.</p>
                </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            ...
                                            <div class="d-flex align-items-center gap-2 mb-2">
                                                <span class="badge bg-primary"><?php echo htmlspecialchars($item['nome_categoria']); ?></span>
                ...
                <div class="d-grid gap-3 d-md-flex justify-content-md-center no-print">
                    ...
                    <a href="miei_acquisti.php" class="btn btn-primary px-4">
                    ...
                    <div class="alert alert-info mt-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0">I tuoi file digitali (PDF) sono disponibili nella sezione <a href="miei_acquisti.php" class="fw-bold">"I miei acquisti"</a> del tuo profilo. Puoi scaricarli in qualsiasi momento.</p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="alert alert-warning mt-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Per i prodotti fisici, il venditore ti contatterà tramite email entro 48 ore per concordare le modalità di consegna. Assicurati di controllare la tua casella di posta.</p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
